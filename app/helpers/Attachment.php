...
class Attachment
{
    ...
    static function addAttachment($file, $model, $folder_name, array $options = []): void
    {
        ...
        $destinationPath = '/home/u503805169/domains/gomltak.com/public_html/Backend' . '/uploads/thumbnails/' . $folder_name . '/';
    ...
    static function updateAttachment($file, $oldFiles, $model, $folder_name, array $options = []): void
    {
        ...
        if ($oldFiles) {
            File::delete('/home/u503805169/domains/gomltak.com/public_html/Backend' . '/' . $oldFiles->path);
        }
    ...
    static function deleteAttachment($model, $relation = 'attachmentRelation', $multiple = false, $type = 'photo')
    {
        ...
        if ($multiple == true) {
            ...
            if($photos)
                File::delete('/home/u503805169/domains/gomltak.com/public_html/Backend' . '/' . $photos->path);
        }
